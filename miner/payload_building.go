...
type BuildPayloadArgs struct {
	...
	NoTxPool     bool                 // Mantle addition: option to disable tx pool contents from being included
	Transactions []*types.Transaction // Mantle addition: txs forced into the block via engine API
	GasLimit     *uint64              // Mantle addition: override gas limit of the block to build
}
